...
;;
;;; Commentary: modified to replace all black to use better in my terminal
;;; Code:
...
(def-doom-theme doom-horizon-custom
  ...
  ((bg         '("#232530" nil       nil            ))
   ...
   ;; custom categories
   (hidden     `(,(car bg) "brightblack" "brightblack"))
